...
(
	...
	ArtikalNaziv CHARACTER LARGE OBJECT NOT NULL,
...
(
	VezaRadnikKorisnickiNalogID INTEGER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1) NOT NULL,
...
(
	PozicijaID INTEGER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1) NOT NULL,
	Naziv CHARACTER VARYING(50) NOT NULL,
	Sifra CHARACTER VARYING(50) NOT NULL,
