...
-- Description:	<>
-- =============================================
alter procedure uspDajPadajucuListuProizvodjaciUljaRoban
...
--HAVING (Proizvodjac.IzvorPodatakaID = @IzvorPodatakaID) AND (Opis.Opis = N'Viskozitet') AND (Opis.IzvorPodatakaID = @IzvorPodatakaID) AND 
...
--               Kriterijum ON VezaArtikalKriterijum.Kriterijum_ID = Kriterijum.Kriterijum_ID INNER JOIN
--               Opis ON Kriterijum.Opis_ID = Opis.Opis_ID
--WHERE (Opis.Opis = N'Viskozitet') AND (Kriterijum.IzvorPodatakaID = @IzvorPodatakaID)
