...
-- Description:	<>
-- =============================================
alter procedure uspDajPadajucuListuSezonaGumaRoban
...
--WHERE (Opis.Opis = N'Sezona') AND (Opis.IzvorPodatakaID = @IzvorPodatakaID) AND (Kriterijum.IzvorPodatakaID = @IzvorPodatakaID) AND 
...
FROM  VezaArtikalKriterijum INNER JOIN
               Kriterijum ON VezaArtikalKriterijum.Kriterijum_ID = Kriterijum.Kriterijum_ID INNER JOIN
               Opis ON Kriterijum.Opis_ID = Opis.Opis_ID
WHERE (Opis.Opis = N'Sezona') AND (Kriterijum.IzvorPodatakaID = @IzvorPodatakaID)
GROUP BY VezaArtikalKriterijum.Vrednost
ORDER BY VezaArtikalKriterijum.Vrednost
