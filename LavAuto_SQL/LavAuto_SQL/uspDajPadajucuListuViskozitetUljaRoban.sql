...
-- Description:	<>
-- =============================================
alter procedure uspDajPadajucuListuViskozitetUljaRoban
...
--WHERE (Opis.Opis = N'Viskozitet') AND (Opis.IzvorPodatakaID = @IzvorPodatakaID) AND (Kriterijum.IzvorPodatakaID = @IzvorPodatakaID) AND 
