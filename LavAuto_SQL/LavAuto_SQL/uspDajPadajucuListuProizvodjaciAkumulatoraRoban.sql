...
-- Description:	<>
-- =============================================
alter procedure uspDajPadajucuListuProizvodjaciAkumulatoraRoban
...
--GROUP BY Proizvodjac.Proizvodjac_ID, Proizvodjac.Naziv, Proizvodjac.IzvorPodatakaID, Opis.Opis, Opis.IzvorPodatakaID, Kriterijum.IzvorPodatakaID, 
--               VezaArtikalKriterijum.IzvorPodatakaID
--HAVING (Proizvodjac.IzvorPodatakaID = @IzvorPodatakaID) AND (Opis.Opis = N'Amperaza') AND (Opis.IzvorPodatakaID = @IzvorPodatakaID) AND 
--               (Kriterijum.IzvorPodatakaID = @IzvorPodatakaID) AND (VezaArtikalKriterijum.IzvorPodatakaID = @IzvorPodatakaID)
...
--               Kriterijum ON VezaArtikalKriterijum.Kriterijum_ID = Kriterijum.Kriterijum_ID INNER JOIN
--               Opis ON Kriterijum.Opis_ID = Opis.Opis_ID
--WHERE (Opis.Opis = N'Amperaza') AND (Kriterijum.IzvorPodatakaID = @IzvorPodatakaID)
...
FROM  Kriterijum INNER JOIN
               Opis ON Kriterijum.Opis_ID = Opis.Opis_ID
WHERE (Kriterijum.IzvorPodatakaID = 2) AND (Opis.Opis = N'Amperaza')
