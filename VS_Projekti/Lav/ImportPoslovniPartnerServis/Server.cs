    ...
    public class Server
    {
        ...
        private List<string> DajListuFajlova()
        {
            try
            {
                ...
                foreach (String item in Directory.GetFiles(konfiguracija.ImportFolder, "KOM*.txt"))
                {
                    lista.Add(item);
                }
                lista.Sort();
        ...
        public void Start()
        {
            try
            {
                ...
                dokumentBrokerThread.Name = "ImportPoslovniPartnerServis";
                ...
                while (true)
                {
                    ...
                    try
                    {
                        foreach (string path in DajListuFajlova())
                        {
                            try
                            {
                                new Obrada().ImportPoslovniPartner(path);
